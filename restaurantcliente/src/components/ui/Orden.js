...
const Orden = ({ orden }) => {
    ...
    // State de los tiempos de los pedidos
        ...
        <div className="sm:w-1/2 lg:w-1/3 px-2 mb-4">
            <div className="p-3 shadow-md bg-white">
                ...
                {orden.orden.map( platillos => (
                    <p className="text-gray-600">{platillos.cantidad}x {platillos.nombre}</p>
                ))}
                ...
                {!orden.completado && orden.tiempoentrega > 0 && (
                    <button
                        type="button"
                        className="bg-blue-800 hover: bg-indigo-700 w-full mt-5 p-2 text-white uppercase font-bold"
