...
const Proyectos = () => {
    ...
    // Apollo
    const { data, loading, error } = useQuery(OBTENER_PROYECTOS);  // Data: la respuesta en caso de que la query se haga con éxito. loading: Mientras hace la consulta a la base de datos = True, cuando termina cambia a False. Error: si la consulta no funciona, retorna un mensaje en esta variable.
